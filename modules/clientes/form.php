                    ...
                    <form role="form" class="form-horizontal" action="modules/clientes/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="ci_ruc" pleaceholder="Ingresa un ruc o ci" autocomplete="off" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="nombre" pleaceholder="Ingresa tu nombre" autocomplete="off" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="apellido" pleaceholder="Ingresa tu apellido" autocomplete="off" required>
                                </div>
                            </div>
