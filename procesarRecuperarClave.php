...
if (isset($_POST['email']) && !empty($_POST['email'])) {
    ...
    try {
        ...
        if ($stmt->rowCount() == 0) {
            header("Location:formRecuperarClave.php?error=1"); // Redirigir si no se encuentra
            exit();
        }
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'aaandrade4@gmail.com'; // Cambia por tu correo
            $mail->Password = 'evqa lqrc ghxa yksv';  // Contraseña de aplicación
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            // Configurar remitente y destinatario
            $mail->setFrom('aaandrade4@gmail.com', 'Administrador');
            ...
            header("Location: index.php?alert=3"); // Éxito
            exit();
        } catch (Exception $e) {
