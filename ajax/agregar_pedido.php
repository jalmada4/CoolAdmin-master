...
<table class="table table-dordered table-striped table-hover">
    <tr class="warning">
        ...
        <th>Producto</th>
        <th><span class="pull-right"></span>Cantidad</th>
        <th><span class="pull-right"></span>Precio</th>
    ...
    <?php
        ...
        while($row=mysqli_fetch_array($sql)){
            ...
            $precio_compra_f=number_format($precio_compra_); //para formatear una variable (poner ,)
